...
register.addEventListener('click', function(e){
    ...
    if(checkFirstname() == false){
        statusFirstname.textContent = 'First name is not valid.'
        statusFirstname.style.color = 'red'
    }
    if(checkLastname() == false){
        statusLastname.textContent = 'Last name is not valid.'
        statusLastname.style.color = 'red'
    }
    if(checkEmail() == false){
        statusEmail.textContent = 'Invalid email.'
        statusEmail.style.color = 'red'
    }
    if(checkSubject() == false){
        statusSubject.textContent = 'Invalid subject.'
